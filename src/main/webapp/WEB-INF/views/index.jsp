    ...
    <div class="container">
            ...
            <div class="header-content">
                ...
                <div class="nav-section">
                    ...
                    <div class="location-btn">
                        ...
                        <span id="location" >Tanakpur</span>
        ...
        <div class="search-section">
            ...
            <div class="search-container">
                ...
                <input type="text" placeholder="Find bus">
                        ...
                        <div class="bus-photos">
                            ...
                            <div style="width: 50%; height: 200px; overflow: hidden; position: relative;">
							  ...
							  <img src="<c:url value='/photo/bus_1.jpg'/>" alt="AC Bus"
							       ...
							       style="width: 80%; height: 60%; object-fit: fit; display: block; padding-left: 2em">
                            ...
                            <div style="width: 50%; height: 200px; overflow: hidden; position: relative;">
									  ...
									  <img src="<c:url value='/photo/bus_2.jpg'/>" alt="Non-AC Bus"
									       ...
									       style="width: 90%; height: 60%; object-fit: fit; display: block; padding-left: 2em; padding-top: 1em">
